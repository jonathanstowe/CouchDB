...
ok(my $obj = CouchDB::Server.new($json), "new from json");

isa-ok($obj, CouchDB::Server, "returns the right sort of thing");
...
isa-ok($obj.vendor, CouchDB::Server::Vendor, "vendor is the right type");
