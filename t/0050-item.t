...
ok Foo.HOW.^isa(Sofa::Item::MetamodelX::ClassHOW) , "the HOW of the class is what we expected";
is Foo.HOW.sofa-path, '_foo', "and the sofa-item is what we expected";

ok Bar.HOW.^isa(Sofa::Item::MetamodelX::ClassHOW) , "the HOW of the class is what we expected";
